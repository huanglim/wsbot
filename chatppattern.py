...
'(秋风拂尘|云龙鞭法)':['天地会掉落的秋风拂尘和丽春院的云龙鞭法一模一样，建议刷秋风因为掉率更高. 所有门派都可以用到大大大后期.'],
'五虎断门刀':['丽春院获取, 五虎断门刀，爆发输出，10秒CD，大部分职业抢门派或收尾爆发用, 可用至血刀前. 少林用燃木刀法.'],
'.*蛇岛奇功$':['神龙教获取,很好的杖法,蛇岛奇功大部分职业都能用到中后期(武道进阶的蛇岛比灵蛇更好). 需要神龙心法200级做前置.建议先宗师再练习不迟'],
