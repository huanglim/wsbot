...
'(你|和尚|小僧|真一|真一你|秃驴)(真|很|非常|简直|是)?.*[^不](笨|丑|傻|蠢|智障|弱智|废)':['*无辜','*难过','你这么说, 真一很伤心!','我会继续努力的, 希望以后你能喜欢我!','不要说我了,师傅又要训我了..'],
...
'起床':['小僧想要睡一会'],
'(早课|晚课)':['*害怕'],
'拜师':['初级拜师没有条件,选好门派直接找最低级的师傅拜即可. 后续需要满足一定的技能等级才可继续拜其他的师傅.'],
...
'擂台':['在扬州城, 打开地图可以找到'],
'基本(暗器|杖法|棍法)?(秘籍|技能|功法)':['当铺可刷新出基本技能秘籍,1金一本, 基本杖法,暗器,棍法在温府可出'],
...
'(绿|蓝|黄)(钓鱼竿|鱼竿)':['关外打渔夫(扫荡也可)出蓝鱼竿, 桃花岛可出黄鱼竿'],
