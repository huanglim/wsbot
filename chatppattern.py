...
'(再)?(讲|来|说|念|读)?(一|1|几)?(个|句|段)?(笑话|段子|xh)':[
    ...
    '牛二因为忍受不了翠花的无理取闹，对翠花吼了一句，翠花马上大哭大闹着说：“你竟然吼我?”气得翠花正准备大闹的时候。牛二：“吼你怎么了?要不是看你长的国色天香，如花似玉，闭月羞花，倾国倾城，温柔善良，我特么早就打你了!”',
],
...
'(收徒|玩家 拜师|出师|师徒)':['宗师大佬可以收徒，徒弟向师父请安可以获得相应收益，徒弟出师师父可以获得奖励(金箱子)，师徒组队完成副本可获得十倍收益'],
...
'.*双修':['双修是什么? 小僧不太明白..'],
'帮派':['在扬州的帮派驻地找帮派管理员可以创建或加入帮派. 帮派可以通过帮贡召唤帮派boss, 打帮派战获取装备等物资!'],
